...
ui <- fluidPage(dashboardPage(dashboardHeader(title="The Coupler"), dashboardSidebar(
  ...
  fluidPage(tags$a(href="https://github.com/rafaelcastanha/The-Coupler-Shiny-App", "Código (GitHub)")),
  ...
  dashboardBody(
    ...
    tabsetPanel(type="tab",
                ...
                tabPanel(title="Unidades de Acoplamento", dataTableOutput(outputId = "DataFrameUnits"),downloadButton("dlunits", "Download Data")),
                
                tabPanel(title="Matriz Citação", dataTableOutput(outputId = "DataFrameCit"),downloadButton("dlcit", "Download Data")),
                
                tabPanel(title="Matriz Acoplamento", dataTableOutput(outputId = "DataFrameMatrix"),downloadButton("dlaba", "Download Data")),
                
                tabPanel(title="Matriz Cocitação", dataTableOutput(outputId = "DataFrameCocit"),downloadButton("dlcocit", "Download Data"))
